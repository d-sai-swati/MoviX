...
import ImgComponent from "../../../components/LazyLoadImage/ImgComponent.jsx";
import Genres from "../../../components/Genres/index.jsx";
import CircleRating from "../../../components/CircleRating/index.jsx";
...
const DetailsBanner = ({ video, crew }) => {
    ...
    // to hours and minutes - movie runtime 
                    ...
                    {!!data && (
                        <React.Fragment>
                            <div className="backdrop-img">
                                <ImgComponent src={url.backdrop + data.backdrop_path} />
                            </div>
                            ...
                            <ContentWrapper>
                                <div className="content">
                                    <div className="left">
                                        {data.poster_path ? (
                                            <ImgComponent className="posterImg" src={url.backdrop + data.poster_path} />
                                        ) : (
                                            <ImgComponent className="posterImg" src={PosterFallback} />
                                        )}
